...
insert  into `bank data`(`sl_no`,`bank_date`,`bank_name`,`bank_account`,`bank_details`,`bank_status`,`bank_amount`) values (1,'2021-02-05','Jamuna Bank','123321131','Purchase','Withdraw','0.00'),(2,'2021-02-05','Jamuna Bank','1222123233','Purchase','Withdraw','0.00'),(3,'2021-02-05','Select','1222123233','Purchase','Withdraw','200'),(4,'2021-02-05','Jamuna Bank','1222123233','Sales','Deposit','600'),(5,'2021-02-08','Pubali Bank','989876767','Purchase','Withdraw','300'),(6,'2021-02-09','Jamuna Bank','123321131','Transportation','Withdraw','1000.0'),(7,'2021-02-13','Pubali Bank','989876767','Purchase','Withdraw','2000'),(8,'2021-02-13','Jamuna Bank','1222123233','Purchase','Withdraw','600'),(10,'2021-02-03','Jamuna Bank','123321131','Purchase','Withdraw','200'),(11,'2021-02-23','Pubali Bank','989876767','Purchase','Withdraw','100'),(12,'2021-02-23','Jamuna Bank','123321131','Sales','Deposit','30'),(13,'2021-02-23','Jamuna Bank','123321131','Sales','Deposit','200'),(14,'2021-02-23','Jamuna Bank','123321131','Sales','Deposit','140'),(15,'2021-02-23','null','null','Purchase Due','Withdraw','10000'),(16,'2021-02-23','null','null','Purchase Due','Withdraw','10000'),(17,'2021-03-01','Islami Bank Limited','3211123322122','From Cash','Deposit','50');
...
insert  into `purchaseorder`(`orderId`,`supplier`,`orderDate`,`deliveryDate`,`category`,`productName`,`price`,`quantity`,`total`) values (1,'Md Mamun','2021-02-17','2021-02-18','cough syrup','Alcolf','200','3','600.0'),(2,'Md Mamun','2021-02-17','2021-02-18','cough syrup','Alcolf','200','2','400.0'),(3,'Md Mamun','2021-02-17','2021-02-18','cough syrup','bashok','190','2','380.0'),(4,'Maruf Ahmed','2021-02-17','2021-02-19','pain killers','Loral 5','150','3','450.0'),(5,'Md Mamun','2021-02-17','2021-02-18','pain killers','napa extra','70','2','140.0'),(6,'Md Ariful islam','2021-02-17','2021-02-19','first aid','5ml Syringe','15','2','30.0'),(7,'Md Ariful islam','2021-02-17','2021-02-19','first aid','5ml Syringe','15','2','30.0'),(8,'Md Ariful islam','2021-02-17','2021-02-19','first aid','5ml Syringe','15','2','30.0'),(9,'Md Mamun','2021-02-17','2021-02-18','first aid','quick bandage','10','3','30.0'),(10,'Md Mamun','2021-02-18','2021-02-20','first aid','quick bandage','10','10','100.0'),(11,'Md Ariful islam','2021-02-17','2021-02-21','first aid','viodin','120','30','3600.0'),(12,'Md Ariful islam','2021-02-17','2021-02-18','first aid','viodin','120','10','1200.0'),(13,'test','2021-02-23','2021-02-23','pain killers','napa extra','70','2','140.0'),(13,'test','2021-02-23','2021-02-23','cough syrup','bashok','190','4','760.0');
...
insert  into `salesorders`(`orderId`,`customer`,`orderDate`,`deliveryDate`,`category`,`productName`,`price`,`quantity`,`total`) values (1,'Md Ahnaf Hossain','2021-02-23','2021-02-24','cough syrup','Alcolf','210','2','420.0'),(2,'Md Arif','2021-02-23','2021-02-24','pain killers','napa extra','80','2','160.0'),(3,'Md Mahmud','2021-02-23','2021-02-24','cough syrup','Alcolf','215','3','645.0'),(4,'Md Mahmud','2021-03-01','2021-03-16','cough syrup','bashok','200','5','1000.0');
...
/*!50001 CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `salesprofit` AS (select `sales entry`.`sales_date` AS `date`,`sales entry`.`product` AS `product`,`purchase entry`.`price` AS `puPrice`,`sales entry`.`price` AS `saPrice`,`sales entry`.`quantity` AS `sQ`,((`sales entry`.`price` - `purchase entry`.`price`) * `sales entry`.`quantity`) AS `unitProfit` from (`sales entry` left join `purchase entry` on((`sales entry`.`product` = `purchase entry`.`product`))) where (`sales entry`.`price` > 0) group by `sales entry`.`sales_id`) */;
